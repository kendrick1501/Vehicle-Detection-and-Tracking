...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 10 17:05:28 2017
...
def get_hog_features(img, orient, pix_per_cell, cell_per_block, 
    ...
    if vis == True:
        ...
        return features.astype(np.float64), hog_image
...
def search_windows(img, windows, clf, scaler, color_space='BGR', 
    ...
    for window in windows:
        ...
        features = single_img_features(test_img, color_space=color_space, 
                            ...
                            hist_feat=hist_feat, hog_feat=hog_feat).astype(np.float64)
...
def draw_labeled_bboxes(img, labels):
    ...
    for car_number in range(1, labels[1]+1):
        ...
        cv2.putText(img,text,(bbox[0][0],bbox[0][1]-10), font, 0.5, (255,255,255) , 1 , cv2.LINE_AA)
    # Return the image
    return img
